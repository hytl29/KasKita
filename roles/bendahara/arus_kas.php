...
if ($filterBulan !== 'Semua Bulan' && isset($bulanMap[$filterBulan])) {
    $qMasuk .= " AND bulan = ?";
    $paramsMasuk[] = $filterBulan;
}
...
<head>
    ...
    <link rel='stylesheet' href='../../assets/css/bendahara/arus_kas.css'>
</head>
