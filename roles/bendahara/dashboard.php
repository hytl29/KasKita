...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/bendahara/dashboard.css">
</head>
        ...
        <div class="dashboard-bottom">
            ...
            <div class="activity-card fade-in">
                <div class="activity-header">
                    ...
                    <a href="buat_transaksi.php" class="btn btn-sm btn-gradient">Buat Transaksi</a>
                </div>
                ...
                <?php if (mysqli_num_rows($qAktivitas) > 0): ?>
                    ...
                    <div class="activity-footer">
                        <a href="arus_kas.php" class="detail">Lihat Detail</a>
                    </div>
                <?php else: ?>
