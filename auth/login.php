...
if (isset($_POST['login'])) {
    ...
    if ($u === '' || $p === '') {
        $error = 'NISN / NIK dan Password tidak boleh kosong!';
    } elseif (!preg_match('/^[0-9]{10}$|^[0-9]{16}$/', $u)) {
        $error = 'NISN / NIK harus 10 atau 16 digit angka!';
    }
    ...
    // Login Wali Kelas (NIK 16 digit)
    elseif (preg_match('/^[0-9]{16}$/', $u)) {

        $query = mysqli_query($conn, "SELECT * FROM walikelas WHERE nik='$u'");
        $data = mysqli_fetch_assoc($query);
        ...
        <div class="login-card">
            ...
            <form action="../auth/login.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="username" class="form-control" placeholder="Masukkan NISN / NIK Anda">
                </div>
